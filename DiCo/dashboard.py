...
# siapkan DataFrame untuk membuat visualisasi data
# kode nya beberapa sudah dibangun di notebook
# untuk mewujudkannya, kita perlu bikin beberapa helper function
...
# ada dua kolom all_df yang bertipe datetime: order_date dan delivery_date
# keduanya akan menjadi kunci dalam pembuatan filter
# untuk mendukung hal ini, kita perlu mengurutkan DataFrame berdasarkan order_date 
...
# tambahkan filter pada dashboar yang akan dibuat
# kita gunakan widget date input sebagai filternya, dan akan ditempatkan pada bagian sidebar
# untuk alasan estetika, kita tambahkan logo perusahaan ke dalam sidebar tersebut
...
with st.sidebar:
    ...
    # Mengambil start_date & end_date daro date_input
...
# sekarang kita lengkapi dashboard dengan visualisasi data
# tambahkan header
st.header('Dicoding Collection Dashboard :sparkles:')

# lalu, tambahkan informasi terkait daily orders pada dashboard
# kita akan tampilkan tiga informasi terkait daily orders, yakni
# jumlah order harian, total order, dan revenue dalam range waktu tertentu
# kita tampilkan dalam bentuk metric() yang ditampilkan menggunakan layout columns()
...
# selanjutnya, sertakan informasi performa penjualan setiap produk
# kita tampilkan 5 produk paling laris dan paling sedikit terjual melalui visualisasi data
...
# tambahkan informasi demografi pelanggan
...
# tambahkan informasi terkait parameter RFM (Recency, Frequency, Monetary)
# kita tampilkan nilai rata-rata dari ketiga parameter tersebut menggunakan widget metric()
